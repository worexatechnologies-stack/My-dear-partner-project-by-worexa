...
urlpatterns = [
    ...
    path('notifications/clear/', MemberNotificationClearView.as_view(), name='member_notifications_clear'),
    ...
    path('notifications/push/config/', MemberWebPushConfigView.as_view(), name='member_web_push_config'),
    path('notifications/push/subscriptions/', MemberWebPushSubscriptionView.as_view(), name='member_web_push_subscription'),
